#> hvr:lib/array/core/mask_inverted
#
# Mask
#
# @within function
...
# Mask or keep
    execute if data storage hvr:lib {mask:false} run data modify storage hvr:lib array append from storage hvr:lib mask_element
    execute if data storage hvr:lib {mask:true} run data modify storage hvr:lib array append from storage hvr:lib copied_array[-1]
