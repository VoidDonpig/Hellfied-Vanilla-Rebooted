...
# Migrate data
    data modify storage hvr:api ignore_fall_damage_from_current_explosion set from storage hvr:entity_manager/storage _.data_cache.data.ignore_fall_damage_from_current_explosion
