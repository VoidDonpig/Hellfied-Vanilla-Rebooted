#> hvr:asset/mob/enemy.skeleton/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "eneny.skeleton"
...
# Attribute
    ...
    data modify storage hvr:asset/mob armor set value 2d
    ...
    data modify storage hvr:asset/mob follow_range set value 48d
    #data modify storage hvr:asset/mob knockback_resistance set value 0.2d
