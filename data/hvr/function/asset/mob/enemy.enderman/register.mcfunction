#> hvr:asset/mob/enemy.enderman/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.enderman"

# Attribute
    #data modify storage hvr:asset/mob max_health set value 1024d
    data modify storage hvr:asset/mob max_absorption set value 10d
    ...
    #data modify storage hvr:asset/mob movement_speed set value 0.25d
    ...
    data modify storage hvr:asset/mob explosion_knockback_resistance set value 0.2d
...
# Equipment
    ...
    data modify storage hvr:asset/mob equipment.feet set value {id:"ender_pearl",components:{enchantments:{frost_walker:1}}}
...
# Drop chances
    ...
    data modify storage hvr:asset/mob drop_chances.feet set value 0f
