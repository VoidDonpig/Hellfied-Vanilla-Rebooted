#> hvr:asset/mob/zombie/tick/boost_buff/reset
#
# Reset boosting
#
# @within function hvr:asset/mob/zombie/tick/boost_buff/increment_timer
...
# Remove tag
    tag @s remove hvr.mob_asset.zombie.boosting
...
# Rebound
    execute unless score $difficulty hvr.global matches 4.. run function hvr:asset/mob/zombie/tick/boost_buff/give_rebound_debuff
