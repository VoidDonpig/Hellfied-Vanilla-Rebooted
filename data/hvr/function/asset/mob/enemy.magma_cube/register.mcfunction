#> hvr:asset/mob/enemy.magma_cube/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.magma_cube"

# Attribute
    #data modify storage hvr:asset/mob max_health set value
    #data modify storage hvr:asset/mob max_absorption set value
    #data modify storage hvr:asset/mob attack_damage set value
    #data modify storage hvr:asset/mob attack_knockback set value
    #data modify storage hvr:asset/mob armor set value
    #data modify storage hvr:asset/mob armor_toughness set value
    ...
    #data modify storage hvr:asset/mob knockback_resistance set value
