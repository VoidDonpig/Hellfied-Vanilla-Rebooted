#> hvr:asset/mob/enemy.zombie_villager/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.zombie_villager"
...
# Attribute
    ...
    data modify storage hvr:asset/mob spawn_reinforcements set value 1d
