#> hvr:asset/mob/enemy.vindicator/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.vindicator"

# Attribute
    data modify storage hvr:asset/mob max_health set value 48d
    ...
    data modify storage hvr:asset/mob armor set value 10d
    ...
    data modify storage hvr:asset/mob knockback_resistance set value 0.75d
