...
# Give ruined miasma
    execute if predicate hvr:interval/20t as @e[type=#hvr:living,type=!warden,tag=!hvr.player_may_exception,distance=..64] run function hvr:asset/mob/warden/give_ruined_miasma