...
# Give ruined miasma
    execute if predicate hvr:interval/20t as @e[type=#hvr:living,type=!warden,tag=!hvr.player_may_exception,tag=!hvr.no_process_mob,distance=..64] run function hvr:asset/mob/warden/tick/give_ruined_miasma