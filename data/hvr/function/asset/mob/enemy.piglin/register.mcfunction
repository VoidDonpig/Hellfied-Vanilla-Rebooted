#> hvr:asset/mob/enemy.piglin/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.piglin"

# Attribute
    data modify storage hvr:asset/mob max_health set value 20d
