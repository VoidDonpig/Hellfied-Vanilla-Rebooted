#> hvr:asset/mob/enemy.evoker/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.evoker"
...
# Attribute
    ...
    data modify storage hvr:asset/mob follow_range set value 32d
...
# Equipment
    ...
    data modify storage hvr:asset/mob equipment.body set value {id:"stone_button",components:{"minecraft:enchantments":{"hvr:asset/mob/enemy.evoker/base":1}}}
