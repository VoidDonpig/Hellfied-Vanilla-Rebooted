#> hvr:asset/mob/enemy.pillager/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.pillager"
...
# Attribute
    ...
    #data modify storage hvr:asset/mob attack_knockback set value 0.6d
    data modify storage hvr:asset/mob armor set value 3d
    #data modify storage hvr:asset/mob armor_toughness set value 5d
    #data modify storage hvr:asset/mob movement_speed set value
    data modify storage hvr:asset/mob movement_efficiency set value 0.4d
    data modify storage hvr:asset/mob water_movement_efficiency set value 0.4d
    #data modify storage hvr:asset/mob follow_range set value
    data modify storage hvr:asset/mob knockback_resistance set value 0.32d
