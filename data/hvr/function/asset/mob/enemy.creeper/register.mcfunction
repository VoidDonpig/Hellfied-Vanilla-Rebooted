#> hvr:asset/mob/enemy.creeper/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.creeper"
...
# Attribute
    ...
    data modify storage hvr:asset/mob knockback_resistance set value 0.6d
...
# Equipment
    ...
    data modify storage hvr:asset/mob equipment.body set value {id:"stone_button",components:{"minecraft:enchantments":{"hvr:asset/mob/enemy.creeper/creeper_immune_to":1}}}
