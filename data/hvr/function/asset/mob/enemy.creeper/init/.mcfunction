...
# Set swell 0
    scoreboard players set @s hvr.asset.mob.enemy.creeper.swell 0

# Save max swell
    execute store result score @s hvr.asset.mob.enemy.creeper.max_swell run data get entity @s Fuse
