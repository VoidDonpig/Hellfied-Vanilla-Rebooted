#> hvr:asset/mob/enemy.warden/sonic_boom/check_target_is_in_radius/check
#
...
# Check if target is in sonic boom radius
    function hvr:asset/mob/enemy.warden/sonic_boom/check_target_is_in_radius/detect.m with storage hvr.__temp__:asset/mob __temp__.warden_pos
