#> hvr:asset/mob/enemy.warden/sonic_boom/check_target_is_in_radius/detect.m
#
# Check target is in the radius
#
# @within function hvr:asset/mob/enemy.warden/sonic_boom/check_target_is_in_radius/check
