#> hvr:asset/mob/enemy.warden/sonic_boom/for_until_reach
#
# Repeat process
#
# @within function
#   hvr:asset/mob/enemy.warden/sonic_boom/proc
#   hvr:asset/mob/enemy.warden/sonic_boom/for_until_reach

# Destroy block
    function hvr:asset/mob/enemy.warden/sonic_boom/destroy_block
...
# Damage
    execute positioned ~-1 ~-1 ~-1 as @e[type=#hvr:living,type=!warden,dx=2,dy=2,dz=2] run function hvr:asset/mob/enemy.warden/sonic_boom/damage

# Decrement count
    scoreboard players remove $sonic_boom_length hvr.temporary 1

# Repeat until reach
    execute unless score $sonic_boom_length hvr.temporary matches ..0 positioned ^ ^ ^1 run function hvr:asset/mob/enemy.warden/sonic_boom/for_until_reach