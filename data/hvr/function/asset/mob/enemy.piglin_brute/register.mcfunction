#> hvr:asset/mob/enemy.piglin_brute/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.piglin_brute"

# Attribute
    data modify storage hvr:asset/mob max_health set value 80d
    data modify storage hvr:asset/mob max_absorption set value 20d
    data modify storage hvr:asset/mob attack_damage set value 20d
    data modify storage hvr:asset/mob attack_knockback set value 4d
    data modify storage hvr:asset/mob armor set value 20d
    data modify storage hvr:asset/mob armor_toughness set value 12d
    ...
    data modify storage hvr:asset/mob explosion_knockback_resistance set value 0.3d
    #data modify storage hvr:asset/mob spawn_reinforcements set value
    #data modify storage hvr:asset/mob scale set value
    data modify storage hvr:asset/mob burning_time set value 0d

# Name
    #data modify storage hvr:asset/mob custom_name set value
...
# Equipment
    ...
    #data modify storage hvr:asset/mob equipment.body set value
...
# Drop chances
    ...
    #data modify storage hvr:asset/mob drop_chances.body set value
...
# Misc NBT
    #data modify storage hvr:asset/mob silent set value
