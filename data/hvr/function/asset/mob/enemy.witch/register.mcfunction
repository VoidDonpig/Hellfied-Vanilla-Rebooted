#> hvr:asset/mob/enemy.witch/register
#
# Register function
#
...
# ID
    data modify storage hvr:asset/mob id set value "enemy.witch"
...
# Attribute
    ...
    data modify storage hvr:asset/mob knockback_resistance set value 0.08d
