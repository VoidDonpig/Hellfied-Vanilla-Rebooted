#> hvr:asset/mob/spider/tick/super_leap/motion/
#
# Calc spider motion
#
# @within function hvr:asset/mob/spider/tick/super_leap/leap_toward_target
...
# Get spider pos
    execute positioned as @s summon marker run function hvr:asset/mob/spider/tick/super_leap/motion/get_pos
    data modify storage hvr.__temp__:asset/mob spider_pos set from storage hvr.__temp__:asset/mob __temp__

# Get target pos
    execute positioned as @n[tag=hvr.target] summon marker run function hvr:asset/mob/spider/tick/super_leap/motion/get_pos
