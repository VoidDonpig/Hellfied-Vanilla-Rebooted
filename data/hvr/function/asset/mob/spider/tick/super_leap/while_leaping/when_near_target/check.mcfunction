#> hvr:asset/mob/spider/tick/super_leap/while_leaping/when_near_target/check
#
# Check XZ distance
#
...
# If under threshold, proceed
    execute if score $horizonal_distance hvr.temporary matches ..1850 run function hvr:asset/mob/spider/tick/super_leap/while_leaping/when_near_target/