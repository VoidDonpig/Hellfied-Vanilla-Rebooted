...
# Remove zombie modifier
    ...
    execute if entity @s[tag=hvr.asset.mob.zombie.boosting] run function hvr:asset/mob/zombie/tick/boost_buff/reset
    execute if entity @s[tag=hvr.asset.mob.zombie.boosting_rebound] run function hvr:asset/mob/zombie/tick/boost_buff/refresh_rebound
