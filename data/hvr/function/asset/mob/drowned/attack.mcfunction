...
# Remove water breathing from victim
    ...
    execute unless data storage hvr.__temp__:asset/mob __temp__.drowned{remove_water_breathing_ok:false} as @n[tag=hvr.victim,tag=!hvr.death] at @s run function hvr:asset/mob/drowned/remove_water_breathing
    data remove storage hvr.__temp__:asset/mob __temp__.drowned.remove_water_breathing_ok