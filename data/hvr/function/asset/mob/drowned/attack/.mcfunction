...
# Remove water breathing from victim
    ...
    execute unless data storage hvr.__temp__:asset/mob __temp__.drowned{remove_water_breathing_ok:false} as @n[type=#hvr:living,tag=hvr.victim,tag=!hvr.death] at @s run function hvr:asset/mob/drowned/attack/remove_water_breathing
