#> hvr:asset/mob/enemy.zombie/tick/boost_buff/refresh_rebound
#
# Reset rebound debuff
#
# @within function hvr:asset/mob/enemy.zombie/tick/boost_buff/increment_refreshing_timer
...
# Remove tag
    tag @s remove hvr.asset.mob.zombie.boosting_rebound
...
# Reset timer
    scoreboard players reset @s hvr.asset.mob.enemy.zombie.boost_buff_rebound_refresh_timer