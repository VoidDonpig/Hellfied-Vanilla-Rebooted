#> hvr:world/weather/thunderstorm/lightning/random_location/random
#
# Random location
#
# @within function hvr:world/weather/thunderstorm/lightning/random_location/choose
...
# Bounds
    execute store result score $additive_x hvr.temporary run random value -96..96
    execute store result score $additive_z hvr.temporary run random value -96..96
