...
# Whether have same effect
    data modify storage hvr:lib array append from storage hvr:entity_manager/storage _.effects[].id
...
# Remove effects from the list
    ...
    data modify storage hvr:entity_manager/storage _.effects set from storage hvr:lib array
