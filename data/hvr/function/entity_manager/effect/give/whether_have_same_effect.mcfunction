...
# Whether have same effect
    data modify storage hvr:lib array append from storage hvr:entity_manager/storage fetched.effects[].id
...
# Remove effects from the list
    ...
    data modify storage hvr:entity_manager/storage fetched.effects set from storage hvr:lib array
