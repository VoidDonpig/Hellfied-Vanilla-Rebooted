...
# If slime or magma cube, init as new mob
    execute if entity @s[type=slime,tag=hvr.asset.mob.slime] run data modify storage hvr:api __input__.id set value "slime"
    execute if entity @s[type=magma_cube,tag=hvr.asset.mob.magma_cube] run data modify storage hvr:api __input__.id set value "magma_cube"
