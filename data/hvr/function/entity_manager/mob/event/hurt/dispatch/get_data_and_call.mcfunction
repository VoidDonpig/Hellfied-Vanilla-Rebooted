#> hvr:entity_manager/mob/event/hurt/dispatch/get_data_and_call
#
...
# Call dispatcher
    function hvr:entity_manager/mob/event/hurt/dispatch/dispatcher.m with storage hvr:asset/context
