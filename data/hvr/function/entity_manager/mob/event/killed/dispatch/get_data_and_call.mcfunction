#> hvr:entity_manager/mob/event/killed/dispatch/get_data_and_call
#
...
# Call dispatcher
    function hvr:entity_manager/mob/event/killed/dispatch/dispatcher.m with storage hvr:asset/context
