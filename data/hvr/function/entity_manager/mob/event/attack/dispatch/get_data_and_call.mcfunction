#> hvr:entity_manager/mob/event/attack/dispatch/get_data_and_call
#
...
# Call dispatcher
    function hvr:entity_manager/mob/event/attack/dispatch/dispatcher.m with storage hvr:asset/context
