#> hvr:entity_manager/mob/event/death/dispatch/get_data_and_call
#
...
# Call dispatcher
    function hvr:entity_manager/mob/event/death/dispatch/dispatcher.m with storage hvr:asset/context
