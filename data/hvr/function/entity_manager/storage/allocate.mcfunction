...
# Evacuate existed data
    execute if data storage hvr:entity_manager/storage fetched run function hvr:entity_manager/storage/save/
...
# Merge artifact
    data modify storage hvr:entity_manager/storage fetched set from storage hvr.__temp__:entity_manager/storage constructing_storage
