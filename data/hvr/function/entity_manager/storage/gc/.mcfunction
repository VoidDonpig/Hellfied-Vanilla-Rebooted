...
# Copy data
    data modify storage hvr.__temp__:entity_manager/storage copied_stored_data set from storage hvr:entity_manager/storage stored
...
# Migrate data
    data modify storage hvr:entity_manager/storage stored set from storage hvr.__temp__:entity_manager/storage retained_data
